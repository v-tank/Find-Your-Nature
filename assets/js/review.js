...
$(document).ready(function(){
	...
	database.ref("/" + parkName).on("child_added", function(childSnapshot){
		...
		$("#reviews-div").append('<br><div class="row"><div class="col-12"><div><strong>'+reviewName+'</strong></div><div><p style="color: #999;" class="mb-2">'+reviewDate+'</p></div><div><p>'+reviewMessage+'</p></div></div></div>');
